...
const appName = "Cream Couch";
createServer(
  (page) => createInertiaApp({
    page,
    render: renderToString,
    title: (title) => `${title} - ${appName}`,
    resolve: (name) => resolvePageComponent(`./pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./pages/Dashboard.vue": () => import("./assets/Dashboard-DueNdjov.js"), "./pages/Welcome.vue": () => import("./assets/Welcome-D9LvnZTF.js"), "./pages/auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-B2_iPqMC.js"), "./pages/auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-f5QNnRPm.js"), "./pages/auth/Login.vue": () => import("./assets/Login-L-J6QU7r.js"), "./pages/auth/Register.vue": () => import("./assets/Register-Cpsxl_Rg.js"), "./pages/auth/ResetPassword.vue": () => import("./assets/ResetPassword-CTP_AdwD.js"), "./pages/auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-BvG2bPqB.js"), "./pages/customers/Index.vue": () => import("./assets/Index-BRjGE2AO.js"), "./pages/customers/Show.vue": () => import("./assets/Show-D8vqBIM0.js"), "./pages/features/FakeNotification.vue": () => import("./assets/FakeNotification-CW5saZ5N.js"), "./pages/orders/Index.vue": () => import("./assets/Index-I8YUyqiI.js"), "./pages/orders/Show.vue": () => import("./assets/Show-Dv_-rLBY.js"), "./pages/products/Index.vue": () => import("./assets/Index-fT1PrN2l.js"), "./pages/products/Show.vue": () => import("./assets/Show-BY90IdW1.js"), "./pages/settings/Appearance.vue": () => import("./assets/Appearance-Dic-hl7q.js"), "./pages/settings/Password.vue": () => import("./assets/Password-DeQa67L3.js"), "./pages/settings/Profile.vue": () => import("./assets/Profile-k8vU_K5n.js") })),
